...
@section('body')
    ...
    <div class="user_zx_right" >
        <div class="box" style="margin-top: 50px">
            <div class="tagMenu">
                <ul class="menu">
                    <li ><a href="{{route("user.msglist")}}">站内短信</a></li>
                    <li class="current"><a href="{{route("user.loginloglist")}}">登录记录</a></li>
                </ul>
            ...
            <div class="container-fluid">
                <div class="row-fluid">
                    <table class="datatable table table-striped table-bordered table-hover ">
                       ...
                       {{-- <tr class="odd gradeX" onclick="$(&quot;#sms.id,#msgid&quot;).slideToggle(2);user_msg(&quot;);">
                            <td>id</td>
                            <td><img src="{{asset("mobile/public/Front/user/read.jpg")}}"> title
    ...
    background-color:#fffcfa;"  id="sms.id">
                                    <div style="width:100%; display:none;" id="msg.id" >content</div>
                                </div>
                            </td>
                            <td>time</td>
                            <td class="center" id="zt.id"><font color="#00A11D">status?'已读':'未读'; </font></td>
                            <td class="center"  id="del.id"><a onclick="user_msg_del(&quot;id&quot;)">删除</a></td>
                        </tr>--}}
