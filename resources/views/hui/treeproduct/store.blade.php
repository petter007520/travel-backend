...
@section('formbody')
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-col-md3">
            <input type="text" name="title" lay-verify="required" required placeholder="树木名称" autocomplete="off" class="layui-input" value="">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="zgje" placeholder="奖励金额" autocomplete="off" class="layui-input" value="">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <label class="layui-form-label col-sm-1">树木状态</label>
