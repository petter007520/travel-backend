    ...
    <div class="layui-form-item">
        ...
        <div class="layui-col-md6">
            ...
            <span class="imgshow" style="float:left;width:100%;margin: 2px;">
                @if($edit->pic!='')
                    <img src="{{$edit->pic_url}}" width="100" style="float:left;"/>
                    @endif
            </span>

            <input type="text" name="pic_url" lay-verify="required" value="{{$edit->pic_url}}" class="layui-input thumb" placeholder="产品图片" style="float:left;width:50%;">
