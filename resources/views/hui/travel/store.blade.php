...
@section('formbody')
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="video_url" placeholder="视频地址(不填写则不展示)" autocomplete="off" class="layui-input" value="">
        </div>
    </div>
     ...
     <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="text" name="img"  class="layui-input thumb" placeholder="缩略图" style="float:left;width:50%;">
            <script>
