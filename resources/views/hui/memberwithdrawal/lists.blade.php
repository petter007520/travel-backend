    ...
    <div class="x-body">
            ...
            <form class="layui-form layui-col-md12 x-so" action="{{ route($RouteController.".lists") }}" method="get">
                ...
                <div class="layui-form layui-input-inline">
                    <select name="s_status" lay-search lay-filter="s_status" lay-search>
                        ...
                        <option value="9" @if(isset($_REQUEST['s_status']) && $_REQUEST['s_status']=='1')selected="selected" @endif>已发起代付</option>
       ...
       {{--
        ...
        <xblock>
            ...
            <button class="layui-btn" onclick="store()"><i class="layui-icon download">&#xe654;</i>充值</button>
...
@section('form')
    ...
    <script id="demo" type="text/html">
        ...
        <tr>
			...
			<td class="td-manage">
                <%# if(item.status==0){ %>
                <a title="代付"  onclick="ConfirmRecThird(<% item.id %>,'1',<% d.current_page %>)" href="javascript:;">
                    <i class="layui-icon" style="color: green;font-size: 16px;">&#x1005;</i>
                </a>
				<%# }%>
            </td>
