...
@section('formbody')
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="url" class="layui-input" lay-verify="required" required placeholder="广告链接URL" value="">
        </div>
    </div>
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea placeholder="请填写广告代码" class="layui-textarea" name="code"></textarea>
        </div>
    </div>
