...
@section('formbody')
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="xmjd" lay-verify="required" required placeholder="进度" autocomplete="off" class="layui-input" value="">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="sort" name="sort"  class="layui-input" placeholder="排序" value="1">
        </div>
    </div>
