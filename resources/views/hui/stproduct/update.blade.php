...
@section('formbody')
   ...
   <div class="layui-form-item">
           ...
           <div class="layui-col-md3">
               <input type="text" name="name" lay-verify="required" required placeholder="商品名称" autocomplete="off" class="layui-input" value="{!! $edit->name !!}">
           </div>
       </div>
       <div class="layui-form-item">
           ...
           <div class="layui-col-md6">
               ...
               <input type="text" name="picurl" value="{!! $edit->picurl !!}" lay-verify="required" class="layui-input thumb" placeholder="商品图片" style="float:left;width:50%;">
   	...
   	<div class="layui-form-item">
           ...
           <div class="layui-input-inline">
               <input type="text" name="fee" placeholder="零售价格" autocomplete="off" class="layui-input" value="{!! $edit->fee !!}">
           </div>
       </div>
       ...
       <div class="layui-form-item">
           ...
           <div class="layui-input-inline">
               <input type="number" name="qtsl" placeholder="起购数量" autocomplete="off" class="layui-input" value="{!! $edit->qtsl !!}">
           </div>
       </div>
       <div class="layui-form-item">
           ...
           <div class="layui-input-inline">
               <input type="number" name="xg_num" placeholder="限购数量" autocomplete="off" class="layui-input" value="{!! $edit->xg_num !!}">
           </div>
       </div>
       <div class="layui-form-item">
           ...
           <div class="layui-input-inline">
               <input type="text" name="guige" placeholder="规格" autocomplete="off" class="layui-input" value="{!! $edit->guige !!}">
           </div>
       </div>
    <script>
   ...
   <!-- <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="firstlevel" autocomplete="off" class="layui-input" value="{!! $edit->firstlevel !!}">
        </div>
       ...
       <div class="layui-input-inline">
           <input type="text" name="secondlevel"  autocomplete="off" class="layui-input" value="{!! $edit->secondlevel !!}">
       </div>
