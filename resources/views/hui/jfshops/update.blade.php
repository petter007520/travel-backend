...
@section('formbody')
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="keyinfo" placeholder="关键字" autocomplete="off" class="layui-input" value="{{$edit->keyinfo}}">
        </div>
    </div>
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea placeholder="请填写描述" class="layui-textarea" name="descr">{{$edit->descr}}</textarea>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="author" class="layui-input" placeholder="作者" value="{{$edit->author}}">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="text" name="image"  class="layui-input thumb" placeholder="缩略图" style="float:left;width:50%;" value="{{$edit->image}}">
            ...
            <span class="product_image_show">
                ...
                @if($photos)
                   @foreach($photos as $img)
                        <img src="{{$img}}" data="{{$img}}" width="100" style="float:left;margin:2px;"  class="productimagesrc"/>
                   @endforeach
                @endif
            ...
            <span class="product_image_data" style="display: none;">
                ...
                @if($photos)
                    @foreach($photos as $k=>$img)
                        <input type="hidden" name="productimage[{{$k}}]" class="productimagedata" value="{{$img}}">
                    @endforeach
                @endif
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="number" name="integral"  class="layui-input" placeholder="积分" value="{{$edit->integral}}">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="number" name="original_price"  class="layui-input" placeholder="原价" value="{{$edit->original_price}}">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="specs"  class="layui-input" placeholder="规格" value="{{$edit->specs}}">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="number" name="click_count"  class="layui-input" placeholder="点击量" value="{{$edit->click_count}}">
        </div>
    </div>
