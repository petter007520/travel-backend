...
@section('formbody')
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="name" lay-verify="required" required placeholder="名称" autocomplete="off" class="layui-input" value="{{$edit->videos_name}}">
        </div>
    </div>
...
<div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <button type="button" class="layui-btn" id="video_url" style="margin-bottom: 5px;">
             ...
             <span class="videoshow" style="display: block;height: 200px;margin-bottom: 5px;">{{--autoplay="autoplay"--}}

                <video id="shakeVideo"  controls="controls" webkit-playsinline="true" playsinline="true" controlslist="nodownload" src="{{$edit->video_url}}" width="50%" height="200px"></video>

            </span>
            <input type="text" name="video_url" lay-verify="" class="layui-input video" placeholder="视频路径" value="{{$edit->video_url}}" style="float:left;width:50%;">
            ...
            <script>
                layui.use('upload', function(){
                    ...
                    var uploadInst = upload.render({
                        elem: '#video_url' //绑定元素
                        , url: '{{route($RouteController.".uploadvideo")}}?_token={{ csrf_token() }}&name={{$edit->video_url}}' //上传接口
                        , field:'files'
                        , exts:'mp4'
                        ,done: function(src){
                            //上传完毕回调
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea placeholder="请填写视频代码" class="layui-textarea" name="code">{{$edit->code}}</textarea>
        </div>
    </div>
