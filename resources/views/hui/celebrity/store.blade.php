...
@section('formbody')
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="author" class="layui-input" placeholder="名家姓名" value="">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="text" name="image" lay-verify="required" class="layui-input thumb" placeholder="缩略图" style="float:left;width:50%;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="radio" name="CelebrityType" value="" title="无" checked="checked">
            @foreach( explode("|",\Cache::get('CelebrityType')) as $itme)
                <input type="radio" name="CelebrityType" value="{{$itme}}" title="{{$itme}}">
            @endforeach
