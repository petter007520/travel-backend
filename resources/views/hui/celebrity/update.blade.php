...
@section('formbody')
    ...
    <div class="layui-form-item">
        <label class="layui-form-label col-sm-1">名家姓名</label>
        <div class="layui-input-inline">
            <input type="text" name="author" class="layui-input" placeholder="名家姓名" value="{{$edit->author}}">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="text" name="image" lay-verify="required" class="layui-input thumb" placeholder="缩略图" style="float:left;width:50%;" value="{{$edit->image}}">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label col-sm-1">名家分类</label>
        <div class="layui-input-block">
            <input type="radio" name="CelebrityType" value="" title="无" @if($edit->CelebrityType=='') checked="checked" @endif>
            @foreach( explode("|",\Cache::get('CelebrityType')) as $itme)
                <input type="radio" name="CelebrityType" value="{{$itme}}" title="{{$itme}}" @if($edit->CelebrityType==$itme) checked="checked" @endif>
            @endforeach
