...
@section('formbody')
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="name" lay-verify="required" required placeholder="联系名称" autocomplete="off" class="layui-input" value="{{$edit->name}}">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="value" lay-verify="required" required placeholder="联系方式" autocomplete="off" class="layui-input" value="{{$edit->value}}">
        </div>
    ...
    <div class="layui-form-item">
     ...
     <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="url" placeholder="链接地址(无需链接请留空)" autocomplete="off" class="layui-input" value="{{$edit->url}}">
        </div>
