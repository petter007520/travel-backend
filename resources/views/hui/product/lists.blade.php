    ...
    <script id="demo" type="text/html">
            ...
            <tr>
                ...
                <!-- <td>
                    ...
                    <%# if(item.issy==0){ %>
                    <input type="checkbox"   lay-skin="switch" lay-filter="switchTest-settop" lay-text="首页|普通" id="<% item.id %>">
                    <%# }else{ %>
                    <input type="checkbox"    checked  lay-skin="switch" lay-filter="switchTest-settop" lay-text="首页|普通" id="<% item.id %>">
