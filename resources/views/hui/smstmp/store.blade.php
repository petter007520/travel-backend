...
@section('formbody')
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            ...
            <input type="text" name="sms_txtname" lay-verify="required" required placeholder="名称" autocomplete="off" class="layui-input" value="{{ $errors->store->first('sms_txtname') }}">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            ...
            <input type="text" name="sms_type"   lay-verify="required" class="layui-input" placeholder="类型" value="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea name="sms_content"  lay-verify="required" class="layui-textarea"></textarea>
