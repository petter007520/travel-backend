...
<input name="s_key" class="s_skey" type="hidden">
@endsection
@section("layermsg")
    @parent
@endsection
...
@section('form')
    ...
    <script id="demo" type="text/html">
        ...
        <tr>
            ...
            <td class="title_<% item.id %>" ><a href="javacript:void(0);" onclick="$('.s_skey').val('<% item.username %>');lists(1,{s_key:'<% item.username %>'})"><% item.username %></a></td>
            <td><% item.ip %></td>
