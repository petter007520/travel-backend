...
@section('formbody')
   ...
   <!-- <div class="layui-form-item">
        ...
        <label class="layui-form-label col-sm-1">等级返利	</label>
...
-->
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            ...
            <input type="text" name="level_fee"   lay-verify="required" class="layui-input" placeholder="累计消费" value="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            ...
            <input type="number" name="min_nl"   lay-verify="required" class="layui-input" placeholder="最小能量值" value="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            ...
            <input type="number" name="max_nl"   lay-verify="required" class="layui-input" placeholder="最大能量值" value="">
