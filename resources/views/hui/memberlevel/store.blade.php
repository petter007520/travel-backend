...
@section('formbody')
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <label>
                <input type="text" name="level" lay-verify="required" class="layui-input" placeholder="累计消费" value="">
            </label>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <label>
                <input type="text" name="rate" lay-verify="required" class="layui-input" placeholder="累计消费" value="">
            </label>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <label>
                <input type="text" name="need_amount" lay-verify="required" class="layui-input" placeholder="累计消费" value="">
            </label>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <label>
                <input type="text" name="need_star_num" lay-verify="required" class="layui-input" placeholder="累计消费" value="">
            </label>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <label>
                <input type="text" name="need_star_level" lay-verify="required" class="layui-input" placeholder="累计消费" value="">
            </label>
        </div>
    </div>

    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label col-sm-1">福利</label>
        <div class="layui-input-block">
            <label>
                <textarea placeholder="请填写福利" class="layui-textarea" name="welfare"></textarea>
            </label>
        </div>
    </div>
    <div class="layui-form-item">
