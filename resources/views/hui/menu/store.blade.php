...
@section('formbody')
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="model_name" lay-verify="required|model_name" autocomplete="off" class="layui-input" placeholder="模型名" value="admin">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="contr_name" lay-verify="required" autocomplete="" class="layui-input" placeholder="控制器" value="{{ $errors->store->first('contr_name').session("contrname") }}">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="action_name"  autocomplete="" class="layui-input" placeholder="操作名" value="{{ $errors->store->first('action_name') }}">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="parent" lay-filter="parent">
                <option value="0" @if($errors->store->first('parent') =='0' ) selected="selected" @endif>顶级</option>
                @if($menu)
                    @foreach($menu as $d)

                        <option value="{{ $d->id }}" @if($errors->store->first('parent') ==$d->id || $d->id==session("parent")) selected="selected" @endif m="{{ $d->model_name }}" c="{{ $d->contr_name }}" a="{{ $d->action_name }}">{{$d->name}}</option>
    ...
    <div class="layui-form-item" pane>
        ...
        <div class="layui-input-inline">
            ...
            <input type="checkbox" checked name="disabled" lay-skin="switch" lay-filter="switchTest" lay-text="ON|OFF">
        </div>
