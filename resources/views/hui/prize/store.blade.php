...
@section('formbody')
    <div class="layui-form-item">
        ...
        <div class="layui-col-md3">
            <input type="text" name="title" lay-verify="required" required placeholder="奖品名称" autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-col-md3">
            <input type="text" name="point" lay-verify="required" required placeholder="兑换现金" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-col-md3">
            <input type="text" name="odds" lay-verify="required" required placeholder="中奖概率(0-10000)" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-col-md6">
            ...
            <input type="text" name="image" lay-verify="required" class="layui-input thumb" placeholder="奖品图片" style="float:left;width:50%;">
            <script>
