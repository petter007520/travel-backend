...
@section('form')
    <script id="demo" type="text/html">
        ...
        <tr>
            ...
            <td id="photo-front-<% item.id %>"><img style="max-width: 15px;" src=<% item.image?item.image:'' %>
            ...
            <td>
                ...
                <input type="checkbox" lay-skin="switch" lay-filter="switchTest-settop" lay-text="置顶|普通"
                       id="<% item.id %>">
                <%# }else{ %>
                <input type="checkbox" checked lay-skin="switch" lay-filter="switchTest-settop" lay-text="置顶|普通"
                       id="<% item.id %>">
                <%# } %>
            </td>
            <td><% item.sort %></td>
