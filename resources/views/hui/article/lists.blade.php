        ...
        <div class="layui-row">
            <form class="layui-form layui-col-md12 x-so" action="{{ route($RouteController.".lists") }}" method="get">
                ...
                <div class="layui-input-inline">
                    ...
                    <input type="text" name="s_key"  placeholder="请输入标题" autocomplete="off" class="layui-input" value="@if(isset($_REQUEST['s_key'])){{$_REQUEST['s_key']}}@endif">
...
@section('form')
    ...
    <script id="demo" type="text/html">
            ...
            <tr>
                ...
                <td  id="photo-front-<% item.id %>"><img style="max-width: 15px;" src=<% item.image?item.image:'' %>  width="15"  onclick="openFrontPhotos(<% item.id %>)"></td>
