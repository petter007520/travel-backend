...
@section('formbody')
    ...
    <div class="layui-form-item">
        <label class="layui-form-label col-sm-1">标识</label>

        <div class="layui-input-block">
            <input type="text" name="key" placeholder="标识" autocomplete="off" class="layui-input" value="{{$edit->key}}">
        </div>
    </div>
    ...
    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label col-sm-1">描述(首页消息轮播修改这里)</label>
        <div class="layui-input-block">
