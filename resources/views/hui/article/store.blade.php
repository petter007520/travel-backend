...
@section('formbody')
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="key" placeholder="标识" autocomplete="off" class="layui-input" value="">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="video_url" placeholder="视频地址" autocomplete="off" class="layui-input" value="">
        </div>
    </div>
