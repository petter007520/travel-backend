    ...
    <SCRIPT type="text/javascript">
        ...
        @if($members)
            ...
            zNodes.push({
                ...
                "recharges": "充值:{{$member->recharges}}",
                "withdrawals": "提现:{{$member->withdrawals}}",
        ...
        function addDiyDom(treeId, treeNode) {
            ...
            var editStr = "<br/><span id='diyBtn_space_" +treeNode.id+ "' > "+treeNode.recharges+"</span><br/><span id='diyBtn_space_" +treeNode.id+ "' > "+treeNode.withdrawals+"</span>";
            aObj.append(editStr);
