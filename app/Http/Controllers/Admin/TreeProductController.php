...
class TreeProductController extends BaseController
{

    private $table="tree_products";
    ...
    public function __construct(Request $request)
    {
        ...
        //var_dump($this->CategoryModel->tree_option(0,0,$category_id,0,$this->table));
        ...
        // }
        $productlist= DB::table("tree_products")->select('id','title')
    ...
    public function xunhuan(){
     ...
     public function new_update_currline(){
        ...
        $product_id = 141;
        $check_huobi = DB::table('tree_products')->where('id',$product_id)->first(); //查看是否存在该货币
        if( !$check_huobi){
