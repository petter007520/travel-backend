...
class ProjectdesController extends BaseController
{

    private $table="projectdes";
    ...
    public function __construct(Request $request)
    {
        ...
        view()->share("tree_option",$this->CategoryModel->tree_option(0,0,$category_id,0,'articles'));
    }
    ...
    public function store(Request $request){
        ...
        if($request->isMethod("post")){
            ...
            $data['xmjd']=\App\Formatting::ToFormat($data['xmjd']);
            $data['sort']=\App\Formatting::ToFormat($data['sort']);
            $data['introduction']=\App\Formatting::ToFormat($data['introduction']);
            $data['status']=1;

           
            $data['created_at']=Carbon::now();

            DB::table("projectdes")->insert($data);
    ...
    public function update(Request $request)
    {
        if($request->isMethod("post")){
            ...
            DB::table("projectdes")->where("id",$id)->update($data);
            ...
            $Model = DB::table('projectdes')->find($request->get('id'));
