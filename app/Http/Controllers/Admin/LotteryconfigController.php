...
class LotteryconfigController extends BaseController
{

    private $table="lotteryconfig";


    public function __construct(Request $request)
    {
        parent::__construct($request);
        $this->Model=new Lotteryconfig();
    ...
    public function store(Request $request){
        ...
        if($request->isMethod("post")){
            ...
            $Model->moneys = $request->input('moneys');
            $Model->prize = $request->input('prize');
            $Model->winningrate = $request->input('winningrate');
    ...
    public function update(Request $request)
    {
        if($request->isMethod("post")){
            ...
            //['name','moneys','prize','winningrate','img'];
