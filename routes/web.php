...
//Route::any('/',  ['as'=>'home','uses'=>'IndexController@index']);//首页
...
Route::group(['middleware' => ['web'],'prefix'=>env('RoutePrefix'),'namespace'=>'Admin'], function () {
    ...
    // Route::any('bonus', ['as'=>'bonus','uses'=>'LoginController@bonus']);//一键分红计划功能
    ...
    // Route::any('month_bonus_pf', ['as'=>'bonus','uses'=>'LoginController@month_bonus']);
    // Route::any('counterbalance', ['as'=>'counterbalance','uses'=>'LoginController@counterbalance']);//每月补贴
    Route::any('statistics_sys', ['as'=>'statistics_sys','uses'=>'LoginController@statistics_sys']);//后台统计
    // Route::any('teamrewards', ['as'=>'teamrewards','uses'=>'LoginController@teamrewards']);//团队奖励
    // Route::any('increase', ['as'=>'increase','uses'=>'LoginController@increase']);//货币涨幅功能
    ...
    // Route::any('update_invicode', ['as'=>'updateline','uses'=>'LoginController@update_invicode']);//货币生成K线
});
