...
Route::any('travelcategory/lists', ['as'=>'travelcategory.lists','uses'=>'TravelCategoryController@lists']);
Route::any('travelcategory/store', ['as'=>'travelcategory.store','uses'=>'TravelCategoryController@store']);
Route::any('travelcategory/update', ['as'=>'travelcategory.update','uses'=>'TravelCategoryController@update']);
Route::any('travelcategory/delete', ['as'=>'travelcategory.delete','uses'=>'TravelCategoryController@delete']);

Route::any('travel/lists', ['as'=>'travel.lists','uses'=>'TravelController@lists']);
Route::any('travel/store', ['as'=>'travel.store','uses'=>'TravelController@store']);
Route::any('travel/update', ['as'=>'travel.update','uses'=>'TravelController@update']);
Route::any('travel/delete', ['as'=>'travel.delete','uses'=>'TravelController@delete']);
...
//社区奖励
Route::any('community_reward/lists', ['as'=>'community_reward.lists','uses'=>'CommunityRewardController@lists']);
Route::any('community_reward/store', ['as'=>'community_reward.store','uses'=>'CommunityRewardController@store']);
Route::any('community_reward/update', ['as'=>'community_reward.update','uses'=>'CommunityRewardController@update']);
