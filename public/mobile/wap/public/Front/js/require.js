var requirejs, require, define; (function(ba) {
    ...
    function S(b, c, d, m) {
        ...
        function(c, l) {
            if (d || !t(b, l)) {
                m && "string" !== typeof c ? (b[l] || (b[l] = {}), S(b[l], c, d, m)) : b[l] = c
            }
        });
        return b
    }
    ...
    function ia(b) {
        ...
        function d(a) {
            A && z(document.getElementsByTagName("script"),
            function(f) {
        ...
        function l(a, f, b, e) {
            ...
            a = a[1];
            i && (i = c(i, d, e), D = m(r, i));
            a && (i ? j = D && D.normalize ? D.normalize(a,
            function(a) {
                return c(a, d, e)
        ...
        function w(a, f) {
            ...
            if (f) {
                ...
                function(f) {
                    if (f = m(q, f)) {
                        f.error = a,
                        f.events.error && (e = !0, f.emit("error", a))
                    }
                }), !e) {
                    h.onError(a)
                }
        ...
        function G(a, f, b) {
            var e = a.map.id;
            a.error ? a.emit("error", a.error) : (f[e] = !0, z(a.depMaps,
            function(e, c) {
                var d = e.id,
                g = m(q, d);
        ...
        function E() {
            var a, f, b, e, n = (b = 1000 * j.waitSeconds) && k.startTime + b < (new Date).getTime(),
            c = [],
            i = [],
            g = !1,
            l = !0;
            if (!X) {
                ...
                if (n && c.length) {
                    return b = B("timeout", "Load timeout for modules: " + c, null, c),
                    b.contextName = k.contextName,
                    w(b)
                }
                l && z(i,
                function(a) {
        ...
        function L(a) {
            ...
            b = k.onScriptError; (!a.detachEvent || Z) && a.removeEventListener("error", b, !1);
            return {
                node: a,
            ...
            callPlugin: function() {
                ...
                function(e) {
                    ...
                    if (this.map.unnormalized) {
                        if (e.normalize && (d = e.normalize(d,
                        function(a) {
                            return c(a, g, !0)
                        }) || ""), e = l(a.prefix + "!" + d, this.map.parentMap), u(e, "defined", v(this,
                        function(a) {
                            this.init([],
                            function() {
                                return a
        ...
        k = {
            ...
            configure: function(a) {
                ...
                H(q,
                function(a, b) { ! a.inited && !a.map.unnormalized && (a.map = l(b))
                });
            ...
            makeRequire: function(a, f) {
                function d(e, c, g) {
                    ...
                    if ("string" === typeof e) {
                        if (J(c)) {
                            return w(B("requireargs", "Invalid require call"), g)
                        }
                        if (a && t(P, e)) {
                            return P[e](q[a.id])
                        }
    ...
    if ("undefined" === typeof define) {
        ...
        h = requirejs = function(b, c, d, p) {
            var g, l = "_"; ! K(b) && "string" !== typeof b && (g = b, K(c) ? (b = c, c = d, d = p) : b = []);
            g && g.context && (l = g.context); (p = m(G, l)) || (p = G[l] = h.s.newContext(l));
            g && p.configure(g);
        ...
        h.load = function(b, c, d) {
            ...
            g;
            if (A) {
                return g = h.xhtml ? document.createElementNS("http://www.w3.org/1999/xhtml", "html:script") : document.createElement("script"),
                g.type = h.scriptType || "text/javascript",
                g.charset = "utf-8",
                g.async = !0,
                g.setAttribute("data-requirecontext", b.contextName),
                g.setAttribute("data-requiremodule", c),
                g.attachEvent && !(g.attachEvent.toString && 0 > g.attachEvent.toString().indexOf("[native code")) && !Z ? (Q = !0, g.attachEvent("onreadystatechange", b.onScriptLoad)) : (g.addEventListener("load", b.onScriptLoad, !1), g.addEventListener("error", b.onScriptError, !1)),
                g.src = d,
                M = g,
                E ? y.insertBefore(g, E) : y.appendChild(g),
                M = null,
                g
            }
            if (ea) {
        ...
        A && O(document.getElementsByTagName("script"),
        function(b) {
            y || (y = b.parentNode);
            if (L = b.getAttribute("data-main")) {
                return s = L,
                u.baseUrl || (F = s.split("/"), s = F.pop(), ga = F.length ? F.join("/") + "/": "./", u.baseUrl = ga),
                s = s.replace(fa, ""),
                h.jsExtRegExp.test(s) && (s = L),
                u.deps = u.deps ? u.deps.concat(s) : [s],
                !0
            }
        });
        define = function(b, c, d) {
            ...
            K(c) || (d = c, c = null); ! c && J(d) && (c = [], d.length && (d.toString().replace(ma, "").replace(na,
            function(b, d) {
                c.push(d)
            }), c = (1 === d.length ? ["require"] : ["require", "exports", "module"]).concat(c)));
            if (Q) {
                if (! (h = M)) {
                    R && "interactive" === R.readyState || O(document.getElementsByTagName("script"),
                    function(b) {
